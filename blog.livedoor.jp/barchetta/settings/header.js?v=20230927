(function () {
    ...
    str += '<tr>';
    str += '<th>';
    str += '<span class="common-header-logo">';
    str += '<a href="https://blog.livedoor.com/?_h_jp_pc=logo" title="livedoor Blog（ライブドア ブログ）TOP">';
    str += '<img height="17" width="94" alt="livedoor Blog（ライブドア ブログ）" src="https://parts.blog.livedoor.jp/img/common/logo_border.svg">';
    str += '</a>';
    str += '</span>';
    str += '</th>';
    ...
    str += 'table#header th img{margin:0;}';
    str += 'table#header span.common-header-logo{white-space:nowrap;margin:0 20px 0 10px;zoom:1;}';
    str += 'table#header span.common-header-logo a{display: flex; align-items: center;}';
    str += 'table#header span.common-header-category{margin-right:20px;}';
    str += 'table#header td.newstickerbox{width:97%;}';
